...
use App\Http\Responses\Import\Product\CreateResponse;
...
// Assuming you're using the import in a controller or service:
        Excel::import($import, $file_path);

        //reponse payload
        $payload = [
            'type' => 'clients',
            'error_count' =>  $import->getErrorImports(),
            'error_ref' => $import_ref,
            'count_passed' => $import->getSuccessfulImports(),
        ];
