                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="items_col_rate"><a class="js-ajax-ux-request js-list-sorting" id="sort_item_rate"
                                    ...
                                    data-url="{{ urlResource('/items?action=sort&orderby=item_rate&sortorder=asc') }}">Số
                                    lượng<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th class="items_col_rate"><a class="js-ajax-ux-request js-list-sorting" id="sort_item_rate"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/items?action=sort&orderby=item_rate&sortorder=asc') }}">Giá
                                    mua<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th class="items_col_rate"><a class="js-ajax-ux-request js-list-sorting" id="sort_item_rate"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/items?action=sort&orderby=item_rate&sortorder=asc') }}">Giá
                                    bán<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th class="items_col_rate"><a class="js-ajax-ux-request js-list-sorting" id="sort_item_rate"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/items?action=sort&orderby=item_rate&sortorder=asc') }}">Nguồn
                                    gốc xuất xứ<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th class="items_col_rate"><a class="js-ajax-ux-request js-list-sorting" id="sort_item_rate"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/items?action=sort&orderby=item_rate&sortorder=asc') }}">Trạng
                                    thái<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                            </th>
