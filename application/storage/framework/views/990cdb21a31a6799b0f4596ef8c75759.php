            ...
            <table id="items-list-table" class="table m-t-0 m-b-0 table-hover no-wrap item-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <th class="items_col_action"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a>
                        </th>
                        <?php endif; ?>
                    </tr>
                </thead>
...
</div><?php /**PATH /home/flashvps/duonghieu.3stech.io.vn/application/resources/views/pages/items/components/table/table.blade.php ENDPATH**/ ?>